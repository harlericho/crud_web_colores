...
--
-- Host: 127.0.0.1    Database: db_crudweb_colores
-- ------------------------------------------------------
...
DELIMITER ;;
CREATE DEFINER=`charlie`@`localhost` PROCEDURE `new_procedure`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`charlie`@`localhost` PROCEDURE `new_procedure1`(IN id_verificador int(11))
BEGIN
